...
def process_text(input_filename, output_filename):
    try:
        ...
        with open(output_filename, 'w') as output_file:
            with open("texts/test.txt", "w") as test_file:
                for arr in mapping_array:
...
def process_text_section2(input_file_path):
    p = inflect.engine()
...
def test_case():
    process_text("texts/scraped_url.txt", "texts/oofdev.txt")
    process_text_section2("texts/oofdev.txt")
